...
@Component({
  selector: 'app-sapecpart1',
  templateUrl: './sapecpart1.component.html',
  styleUrls: ['./sapecpart1.component.scss']
})
export class Sapecpart1Component implements OnInit {
  title = 'mcq';
  ...
  constructor(
    private dataservice: Quizec1Service,
    private counterservice: Flagshareec1Service
  ) {
