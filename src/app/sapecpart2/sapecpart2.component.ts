...
@Component({
  selector: 'app-sapecpart2',
  templateUrl: './sapecpart2.component.html',
  styleUrls: ['./sapecpart2.component.scss']
})
export class Sapecpart2Component implements OnInit {
  title = 'mcq';
  ...
  constructor(
    private dataservice: Quizeec2Service,
    private counterservice: Flagshareec2Service
  ) {
