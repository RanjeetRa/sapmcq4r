...
@Component({
  selector: 'app-sappgdm',
  templateUrl: './sappgdm.component.html',
  styleUrls: ['./sappgdm.component.scss']
})
export class SappgdmComponent implements OnInit {
  title = 'mcq';
  ...
  onClick(){
    ...
    // this.router.navigateByUrl("/sapec1");
  }
